...
func newGenChromaStyle() *genChromaStyles {
	g := &genChromaStyles{}
	g.style          = "nightowl"  // replace with cli argument 0
	g.highlightStyle = "bg:#ffffcc"// replace with cli argument 1
	g.linesStyle     = ""          // replace with cli argument 2
	return g
}
...
func main() {
	style := newGenChromaStyle()
	style.generate()
	//creatGenChromaStyles()
}
